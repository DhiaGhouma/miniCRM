        ...
        {showSuccess && (
          <Alert className="border-green-200 bg-green-50">
            ...
            <AlertDescription className="text-green-800">
              Le client a été ajouté avec succès à votre système CRM ! Redirection en cours...
            </AlertDescription>
          </Alert>
        )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.status} onValueChange={(value: 'active' | 'inactive' | 'prospect') => handleInputChange('status', value)}>
                  <SelectTrigger className="bg-slate-50 border-slate-300 focus:border-blue-500 focus:ring-blue-500">
              ...
              <div className="space-y-2">
                ...
                <div className="p-4 bg-slate-50 rounded-lg border border-slate-200">
                  <p className="text-sm text-slate-600 mb-3">
                    Ajoutez des tags pour organiser et catégoriser ce client
                  </p>
                  <TagInput
                    clientId="temp"
